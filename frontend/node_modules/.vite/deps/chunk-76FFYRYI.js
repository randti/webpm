  ...
  if (isArray2(val)) {
    ...
    if (name.startsWith("--")) {
      ...
      if (importantRE.test(val)) {
        style.setProperty(hyphenate2(prefixed), val.replace(importantRE, ""), "important");
      } else {
        style[prefixed] = val;
      }
    }
...
var VueElement = class extends BaseClass {
  ...
  _resolveDef() {
    ...
    const resolve2 = (def2) => {
      ...
      for (const key of rawKeys.map(camelize2)) {
  ...
  _setAttr(key) {
    ...
    this._setProp(camelize2(key), value, false);
  }
  _getProp(key) {
...
var TransitionPropsValidators = Transition.props = extend2({}, BaseTransition.props, DOMTransitionPropsValidators);
...
//# sourceMappingURL=chunk-76FFYRYI.js.map
