...
class FormulaParser extends _chevrotain.EmbeddedActionsParser {
  constructor(lexerConfig, sheetMapping) {
    ...
    this.columnRangeExpression = this.RULE('columnRangeExpression', () => {
      ...
      } = this.orderColumnRangeEnds(firstEnd, secondEnd);
      return (0, _Ast.buildColumnRangeAst)(start, end, sheetRefType, range.leadingWhitespace);
    });
    /**
    ...
    this.rowRangeExpression = this.RULE('rowRangeExpression', () => {
      ...
      } = this.orderRowRangeEnds(firstEnd, secondEnd);
      return (0, _Ast.buildRowRangeAst)(start, end, sheetRefType, range.leadingWhitespace);
    });
    /**
  ...
  buildCellRange(firstAddress, secondAddress, leadingWhitespace) {
    ...
    } = this.orderCellRangeEnds(firstEnd, secondEnd);
    return (0, _Ast.buildCellRangeAst)(start, end, sheetRefType, leadingWhitespace);
  }
  ...
  orderCellRangeEnds(endA, endB) {
    ...
    return {
      start: _CellAddress.CellAddress.fromColAndRow(startCol, startRow, startSheet),
      end: _CellAddress.CellAddress.fromColAndRow(endCol, endRow, endSheet)
    };
  }
