...
* The following dependencies are not known to work with Spring Native: 'Spring for GraphQL, Rest Repositories, Spring Session, Spring Configuration Processor, Jersey, Rest Repositories HAL Explorer, Spring Web Services, Vaadin, Spring Boot DevTools, Spring HATEOAS'. As a result, your application may not work as expected.
